...
cat model/llama3.2/optimizer.pt.part_*              > model/llama3.2/optimizer.pt
...
echo "Done. Load each adapter with PEFT on top of the base model listed in adapter_config.json."
