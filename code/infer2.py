...
model_name = "final_model_classifier.pt"
max_seq_length = 8192
...
def compute_metrics(eval_pred):
    ...
    with open('qwen_data.pkl', 'wb') as fp:
        pickle.dump((logits, labels, predictions), fp)
    results = {
        'accuracy': accuracy,
...
if __name__ == '__main__':
    ...
    raw_datasets["test"] = raw_datasets["test"].shuffle().select(range(20000))
    ...
    training_args = TrainingArguments(
        output_dir="outputs_8b_classifier_infer",
