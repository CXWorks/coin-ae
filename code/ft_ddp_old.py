...
def is_main_process(training_args):
    return training_args.local_rank in [-1, 0]
...
def main():
    ...
    if is_main_process(training_args):
        setup_ddp(training_args.local_rank, training_args.n_gpu)
    ...
    # # Init a model
    model = init_model(training_args.local_rank)
