# AE for COIN: Detecting Modular Unsafe Rust Function
...
3. The `data` folder includes the modular unsafe Rust dataset we used in training process: train/validation/test
